...
// @Summary      Unfollow comic
// @Description  Unfollow a comic for the current user
// @Tags         Comic
// @Accept       json
// @Produce      json
...
// @Router       /comics/{comicSlug}/follow [delete]
func (h *ComicHandler) unfollowComic(c *gin.Context) {
	...
	result := h.comicService.UnfollowComic(c.Request.Context(), user.ID, comicID)
